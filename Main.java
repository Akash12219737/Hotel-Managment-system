...
{
    Doubleroom luxury_doublerrom[]=new Doubleroom[10]; //Room no.:-1-10
    Doubleroom deluxe_doublerrom[]=new Doubleroom[20]; //Room no.:-11-30
    Singleroom luxury_singleerrom[]=new Singleroom[10]; //Room no.:-31-40
    Singleroom deluxe_singleerrom[]=new Singleroom[20]; //Room no.:-41-60
}

class Hotel
{
    static holder hotel_ob=new holder();  // static access call anywhere
